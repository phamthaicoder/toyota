...
readMoreAll.forEach(function (readMore) {
  return readMore.addEventListener("click", function (e) {
...
collapseAll.forEach(function (collapse) {
  return collapse.addEventListener("click", function (e) {
...
sliderImageAll.forEach(function (sliderImage) {
  return sliderImage.addEventListener("mouseover", function (e) {
    sliderImage.classList.add('active');
  });
});
sliderImageAll.forEach(function (sliderImage) {
  return sliderImage.addEventListener("mouseout", function (e) {
...
modalAll.forEach(function (modal) {
  return modal.addEventListener('show.bs.modal', function (event) {
    htmlElement.style.overflowY = "hidden";
  });
});
modalAll.forEach(function (modal) {
  return modal.addEventListener('hide.bs.modal', function (event) {
    htmlElement.style.overflowY = "unset";
  });
}); //Get the button

var scrollToTopBtn = document.getElementById("scroll-to-top");
var scrollToBottomBtn = document.getElementById("scroll-to-bottom"); // When the user scrolls down 1000px from the top of the document, show the button
